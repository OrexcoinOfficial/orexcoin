 ...
 * orexcoin public-key-hash-addresses have version 55 (or 111 testnet).
...
public:
    enum
    {
        PUBKEY_ADDRESS = 115,  // coin: addresses begin with 'o'
        SCRIPT_ADDRESS = 137, // coin: addresses begin with 'x'

...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Orexcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
	{"seed0", "seed0.nodeserver.info"},
    {"seed1", "seed1.nodeserver.info"},
    {"seed2", "seed2.nodeserver.info"},
    {"seed3", "seed3.nodeserver.info"},
    {"seed4", "seed4.nodeserver.info"},
    {"seed5", "seed5.nodeserver.info"},
    {"seed6", "seed6.nodeserver.info"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Orexcoin is probably already running."), addrBind.ToString().c_str());
        else

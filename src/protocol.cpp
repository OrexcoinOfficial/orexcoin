...
static unsigned char pchMessageStartTestNew[4] = { 0xd2, 0xa6, 0xee, 0xce };
static unsigned int nMessageStartTestSwitchTime = 1346200000;

// Orexcoin message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xf9, 0xbe, 0xb4, 0xd9 };
static unsigned char pchMessageStartOrexcoin[4] = { 0x75, 0x3d, 0x3b, 0xba };
static unsigned int nMessageStartSwitchTime = 1347300000;

unsigned char pchMessageStart[4] = { 0x75, 0x3d, 0x3b, 0xba };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartOrexcoin : pchMessageStartBitcoin, sizeof(pchMessageStartOrexcoin));
}

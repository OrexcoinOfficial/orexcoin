...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("OREX");
    case mBTC: return QString("mOREX");
    case uBTC: return QString::fromUtf8("μOREX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Orexcoins");
    case mBTC: return QString("Milli-Orexcoins (1 / 1,000)");
    case uBTC: return QString("Micro-Orexcoins (1 / 1,000,000)");
    default: return QString("???");
    }
}

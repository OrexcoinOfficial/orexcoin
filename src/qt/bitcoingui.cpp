 ...
 * The Orexcoin developers 2011-2018
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Orexcoin") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/orexcoin"));
    setWindowIcon(QIcon(":icons/orexcoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Orexcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/orexcoin"), tr("&About Orexcoin"), this);
    aboutAction->setStatusTip(tr("Show information about Orexcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Orexcoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/orexcoin"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Orexcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Orexcoin addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/orexcoin"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://orexcoin.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/orexcoin"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.orexcoin.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/orexcoin_testnet"));
            setWindowIcon(QIcon(":icons/orexcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/orexcoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Orexcoin client"));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://orexcoin.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.orexcoin.net"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Orexcoin network", "", count));
}
...
{
    QString strTitle = tr("Orexcoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Orexcoin address or malformed URI parameters."),

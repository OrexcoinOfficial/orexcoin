...
UNIX BUILD NOTES FOR OREXCOIN
====================

To build in Terminal on Debian based Linux
---------------------

	git clone https://github.com/orexcoin/orexcoin
	cd orexcoin
...
This will build Orexcoin-Qt as well if the dependencies are met.
...
Note: Currently, there is no orexcoin ebuild available in overlay 
...
Notes
-----
The release is built with GCC and then "strip orexcoind" to strip the debug
